	...
	extend_parameter (a_object: detachable ANY)
		...
		do
			if attached a_object as l_obj then
				...
				extend (create {DB_BIND_MARIADB}.make (mysql_type_null, Void, 0))
			end
		end
	...
	replace_parameter (i: INTEGER; a_object: detachable ANY)
		...
		do
			if attached a_object as l_obj then
				...
				put_i_th (create {DB_BIND_MARIADB}.make (mysql_type_null, Void, 0), i)
			end
		end
...
feature {NONE} -- Implementation
	...
	object_to_pointer (a_obj: ANY): DB_BIND_MARIADB
