note
	description: "[
		Factory for creating CSPRNG instances on Unix/Linux/macOS.
		
		This Unix-specific implementation uses /dev/urandom or getrandom()
...
feature -- Factory
	...
	new_csprng: CSPRNG
			-- Create a new CSPRNG using Unix /dev/urandom.
		do
			create {URANDOM_RNG} Result.make
		ensure
