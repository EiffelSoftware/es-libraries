...
feature -- Test routines
	...
	test_write_quoted_string
		...
		do
			create writer.make
			create str.make_double_quoted ("hello: world")
	...
	test_reset
		...
		do
			create writer.make
			writer.write_value (create {YAML_STRING}.make_plain ("test"))
	...
	test_write_nested_structure
		...
		do
			...
			create outer.make
			create inner.make
			inner.extend (create {YAML_STRING}.make_plain ("a"))
			inner.extend (create {YAML_STRING}.make_plain ("b"))
	...
	test_escape_special_chars
		...
		do
			create writer.make
			create scalar.make_double_quoted ("line1%Nline2")
			writer.write_value (scalar)
