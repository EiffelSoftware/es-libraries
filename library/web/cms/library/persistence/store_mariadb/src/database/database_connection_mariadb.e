note
	description: "Object that handle a database connection for MariaDB"
	date: "$Date$"
	revision: "$Revision$"

class
	DATABASE_CONNECTION_MARIADB
...
feature -- Initialization
	...
	login_with_default
			-- Create a database handler for MariaDB with common settings.
		do
...
feature -- Database Connection
	...
	db_application: DATABASE_APPL [MARIADB]
