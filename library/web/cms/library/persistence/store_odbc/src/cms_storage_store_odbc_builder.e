...
feature -- Factory
	...
	storage (cfg: DATABASE_CONFIGURATION; a_setup: CMS_SETUP; a_error_handler: ERROR_HANDLER): detachable CMS_STORAGE_STORE_ODBC
		local
			conn: detachable DATABASE_CONNECTION
			l_connection_string: READABLE_STRING_32
		do
			if cfg.driver.is_case_insensitive_equal ("odbc") then
