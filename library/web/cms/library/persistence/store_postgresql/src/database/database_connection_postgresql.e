note
	description: "Object that handle a database connection for POSTGRESQL"
	date: "$Date$"
	revision: "$Revision$"

class
	DATABASE_CONNECTION_POSTGRESQL
...
feature -- Initialization
	...
	login_with_default
			-- Create a database handler for POSTGRESQL with common settings.
		do
	...
	login (a_username: STRING; a_password: STRING; a_hostname: STRING; a_database_name: STRING; connection: BOOLEAN)
			...
			-- Create a database handler for POSTGRESQL and set `username' to `a_username',
	...
	login_with_connection_string (a_string: STRING)
		...
		do
			...
			l_port := connection_string_item (a_string, "Port", "5432")
...
feature -- Database Connection
	...
	db_application: DATABASE_APPL [POSTGRESQL]
