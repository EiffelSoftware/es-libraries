...
feature {NONE} -- Initialization
	...
	make (data1: NATURAL_32; data2, data3: NATURAL_16; data4: ARRAY [NATURAL_8])
		...
		do
			...
			internal_item.put_natural_32_le (data1, data_1_pos)
			internal_item.put_natural_16_le (data2, data_2_pos)
			internal_item.put_natural_16_le (data3, data_3_pos)
...
feature -- Element change
	...
	set_data_1 (a_value: NATURAL_32)
		...
		do
			internal_item.put_natural_32_le (a_value, data_1_pos)
		ensure
	...
	set_data_2 (a_value: NATURAL_16)
		...
		do
			internal_item.put_natural_16_le (a_value, data_2_pos)
		ensure
	...
	set_data_3 (a_value: NATURAL_16)
		...
		do
			internal_item.put_natural_16_le (a_value, data_3_pos)
		ensure
